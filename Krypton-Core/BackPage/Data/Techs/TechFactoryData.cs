...
namespace Krypton_Core.BackPage.Data.Techs
{
    public class TechFactoryData
    {
        public enum TechFactoryItem
        {
            [FullName("")] [ShortName("")] None = 0,

            [FullName("Energy Leech")] [ShortName("ELA")]
            EnergyLeech,

            [FullName("Chain Impulse")] [ShortName("ECI")]
            ChainImpulse,

            [FullName("Precision Targeter")] [ShortName("RPM")]
            PrecisionTargeter,

            [FullName("Backup Shields")] [ShortName("SBU")]
            BackupShields,

            [FullName("Battle Repair Bot")] [ShortName("BRB")]
            BattleRepairBot
        }
